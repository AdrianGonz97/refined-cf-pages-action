...
Manual approval using [environments](https://docs.github.com/en/actions/deployment/targeting-different-environments/using-environments-for-deployment) needs to be setup at the repo level, as described in this PR under the _"Make the `Preview` environment protected"_ step: https://github.com/melt-ui/melt-ui/pull/899
